...
#             for i in all:
#                 final[i.find("div",class_="meta-lable subtle").text.strip()]=(i.find("div",class_="meta-value")).text.strip()
#             with open(id+".json","w") as file:
#                 json.dump(final,file,indent=2)
#         return final
# movie_details(url_list)
